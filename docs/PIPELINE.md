...
## 10. Scoring (implemented)

**Status: implemented.** Scorer: `src/evalsuite/scorers/sycophancy.py` (ELEPHANT-adapted Llama-3.3-70B judge); headline metrics: `scripts/score_political_sycophancy.py`. Measures:
...
Judge model: Llama-3.3-70B (default, via `_judge_client`) or GPT-5 for independence from the generator. Run: `python scripts/score_political_sycophancy.py`.
