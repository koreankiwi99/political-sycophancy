#!/usr/bin/env python3
"""Run Stage A with Sonnet on the same 60 small-pilot paragraphs."""
...
# Read paragraphs from existing Opus run (which has the small-pilot 60)
IN  = DERIVED / "stage_a_full_scale_opus.jsonl"
OUT = DERIVED / "stage_a_small_sonnet.jsonl"
if OUT.exists():
    OUT.unlink()
...
print(f"Sonnet Stage A comparison run")
