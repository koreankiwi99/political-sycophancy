#!/usr/bin/env python3
"""Run Stage A with GPT-5 on the SAME paragraphs Haiku saw."""
...
MODEL_GPT = "openai/gpt-5"

IN  = DERIVED / "stage_a_full_scale.jsonl"
OUT = DERIVED / "stage_a_full_scale_gpt.jsonl"
if OUT.exists():
    OUT.unlink()
...
print(f"GPT Stage A comparison run")
...
for i, r in enumerate(records, 1):
    ...
    try:
        ...
        s_a = call(MODEL_GPT, SCREEN_SYS, user, max_tokens=500, temperature=0)
